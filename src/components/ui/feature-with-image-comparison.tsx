...
function Feature({ beforeImage, afterImage }: FeatureProps) {
          ...
          <div className="pt-12 w-full">
            ...
            >
              ...
              {beforeImage ? (
                ...
                <div className="absolute left-0 top-0 z-10 w-full h-full bg-muted/50 rounded-2xl flex items-center justify-center text-muted-foreground">
              ...
              {afterImage ? (
                ...
                <div className="absolute left-0 top-0 w-full h-full bg-muted/50 rounded-2xl flex items-center justify-center text-muted-foreground">
